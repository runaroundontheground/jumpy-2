...
stickAnim = {
    "run": [pygame.image.load(path+"/images/stick figure/run.png").convert_alpha(), 0, 22, 0, 1],
     # 22 frames, run at 22 - 44 fps, scale by 0.28
    "walk": [pygame.image.load(path+"/images/stick figure/walk.png").convert_alpha(), 0, 16, 0, 1],
     # 16 frames, run at 16 - 32 fps, scale by 0.255
    "idle": [pygame.image.load(path+"/images/stick figure/idle.png").convert_alpha(), 0, 2, 0, FPS]#,
...
def transformImage (imageSource, animation, scale) :
...
transformImage(stickAnim, "run",  0.28);
transformImage(stickAnim, "walk", 0.255);
transformImage(stickAnim, "idle", 0.255);
